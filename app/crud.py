""" This helper function contains all the CRUD functions for the database

Get single player, league, team by id; 

Get many players, leagues, teams with optional filters;

Get player performances filtered by date; count players, teams, leagues  

All functions need a db session to work
...
from app import models  # refers to models.py file
